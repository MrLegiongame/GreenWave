...
def is_vehicle_relevant(vehicle, start_seconds, end_seconds):
    ...
    # Exclude vehicles that will arrive to a queue  TODO: decide what to do with this check
    # if is_to_green and result:
    #     result = result and not lane.will_be_there_queue_in_given_seconds_for_to_green(vehicle, is_now_green)
...
def get_filter_value(filter, traffic_lights, is_now_green, same_state_check_flag=None, seconds=None):
    """
        ...
        Args:
            ...
            is_now_green (bool): Whether traffic lights are now green
...
class Junction:
    ...
    def calculate_green_wave_switch_score(self, filter, next_active_index, seconds=None):
        ...
        traffic_lights_to_turn_green = tuple(traffic_lights_currently_red.intersection(traffic_lights_will_be_green))
